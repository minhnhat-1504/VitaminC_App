...
class StudyService {
  ...
  Future<List<VocabModel>> getDueCards({String? deckId, bool forceStudy = false}) async {
    try {
      ...
      final localCards = _localDb.getLocalDueCards(deckId: deckId, forceStudy: forceStudy);
      ...
      throw AppExceptionHandler.handleException(e, 'Lỗi khi tải thẻ ôn tập từ Local DB');
    }
  }
